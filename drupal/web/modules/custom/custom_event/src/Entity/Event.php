...
use Drupal\custom_event\EventInterface;
 ...
 *   handlers = {
 *     "list_builder" = "Drupal\custom_event\EventListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "access" = "Drupal\custom_event\EventAccessControlHandler",
 *     "form" = {
 *       "add" = "Drupal\custom_event\Form\EventForm",
 *       "edit" = "Drupal\custom_event\Form\EventForm",
